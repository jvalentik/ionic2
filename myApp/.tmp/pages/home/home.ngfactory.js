...
var _View_HomePage0 = (function (_super) {
    ...
    _View_HomePage0.prototype.createInternal = function (rootSelector) {
        ...
        this._el_15 = this.renderer.createElement(this._el_14, 'button', null);
        ...
        this._Button_15_4 = new import15.Wrapper_Button(null, '', this.parentInjector.get(import16.Config), new import17.ElementRef(this._el_15), this.renderer);
        this._appEl_15.initComponent(this._Button_15_4.context, [], compView_15);
        this._text_16 = this.renderer.createText(null, 'Get Balance', null);
    ...
    _View_HomePage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        ...
        if (((token === import26.Button) && ((15 <= requestNodeIndex) && (requestNodeIndex <= 16)))) {
            return this._Button_15_4.context;
        }
        if (((token === import27.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 17)))) {
    ...
    _View_HomePage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_3 = import4.interpolate(1, 'My balance is : ', this.context.balance, '');
    ...
    _View_HomePage0.prototype._handle_click_15_0 = function ($event) {
        ...
        var pd_0 = (this.context.getBalance() !== false);
        return (true && pd_0);
    };
