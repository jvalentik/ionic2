...
class _View_HomePage0 extends import1.AppView<import0.HomePage> {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._el_15 = this.renderer.createElement(this._el_14,'button',(null as any));
    this.renderer.setElementAttribute(this._el_15,'ion-button','');
    this._appEl_15 = new import3.AppElement(15,14,this,this._el_15);
    var compView_15:any = import15.viewFactory_Button0(this.viewUtils,this.injector(15),this._appEl_15);
    this._Button_15_4 = new import15.Wrapper_Button((null as any),'',this.parentInjector.get(import16.Config),new import17.ElementRef(this._el_15),this.renderer);
    this._appEl_15.initComponent(this._Button_15_4.context,([] as any[]),compView_15);
    this._text_16 = this.renderer.createText((null as any),'Get Balance',(null as any));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import26.Button) && ((15 <= requestNodeIndex) && (requestNodeIndex <= 16)))) { return this._Button_15_4.context; }
    if (((token === import27.Content) && ((9 <= requestNodeIndex) && (requestNodeIndex <= 17)))) { return this._Content_9_4.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_3:any = import4.interpolate(1,'My balance is : ',this.context.balance,'');
  ...
  private _handle_click_15_0($event:any):boolean {
    ...
    const pd_0:any = ((<any>this.context.getBalance()) !== false);
    return (true && pd_0);
  }
}
